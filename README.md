...
[![License: MIT](https://img.shields.io/badge/License-LGPL-green.svg)](https://opensource.org/licenses/LGPL)

**Snippets LGPL** es una colección de código funcional generado como parte de la 
...
> ⚠️ Si buscas el repositorio **SnippetsMIT**, ese es un repositorio separado 
> con licencia distinta. Este repositorio es exclusivamente LGPL
...
## 📂 Archivos Disponibles en MIT (como ejemplo)
...
Este repositorio se distribuye bajo licencia **LGPL**.
...
revisa el repositorio **SnippetsMIT**.
